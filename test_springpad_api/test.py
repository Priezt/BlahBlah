...
request = oauth.Request.from_consumer_and_token(consumer, token=access_token, http_url="http://springpadit.com/api/users/me/blocks?limit=25&sort=created", http_method='GET')
